      ...
      <div className="bg-white p-12">
        <div className="flex items-center mb-4 px-4 pb-8 border-b border-gray-600">
          ...
          <div className='pl-8 flex w-full'>
            ...
            <Link href='/playlists/new' className='flex items-center ml-auto mr-12'>
              ...
              <h2 className='ml-2 text-xl font-bold pb-0.5'>新建歌单</h2>
            </Link>

            <button className='flex items-center ml-2 mr-12'>
