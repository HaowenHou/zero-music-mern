...
const Sidebar = () => {
    return (
        <aside className="bg-gray-50 w-64 h-screen">
            <div className='p-4 flex'>
                <svg className='size-10 stroke-orange-500' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
