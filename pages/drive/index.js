      ...
      <div className="bg-white p-12">
        <div className="flex items-center mb-4 p-4 pb-8 border-b border-gray-600">
          <div className='relative'>
            <img src="/assets/default-favorite.png" className='size-28 rounded-lg' />
          ...
          <div className='pl-8'>
            <h1 className="text-2xl font-bold">我的云盘</h1>
            <div className="flex">
              <button className='flex mt-4 items-center'>
                ...
                <h2 className='pl-2 text-xl font-bold pb-0.5'>播放云盘</h2>
              </button>
              <Link href='/drive/manage' className="flex mt-4 items-center ml-8">
                ...
                <h2 className='ml-2 text-xl font-bold pb-0.5'>管理云盘</h2>
              </Link>
            </div>
          </div>
        </div>
