...
export default function Playlist() {
  ...
  const handleRemoveFromPlaylist = async (trackId) => {
    try {
      const response = await axios.patch(`/api/playlist?playlistId=${playlistId}&trackId=${trackId}&action=remove`);
      ...
      <div className="bg-white p-12">
        <div className="flex items-center mb-4 p-4 pb-8 border-b border-gray-600">
          <div className='relative'>
            <img src={playlist.cover || '/assets/default-cover-1.png'} className='size-28 rounded-lg' />
