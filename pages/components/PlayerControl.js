...
const PlayerControl = () => {
  ...
  useEffect(() => {
    const newAudio = new Audio(playlist[currentTrackIndex].track);
    ...
    <div className='flex bg-gray-50 min-h-20'>
      <div className='flex flex-[3] items-center'>
        <button className='relative ml-3' onClick={() => console.log(1)}>
          ...
          <img src={playlist[currentTrackIndex].cover} className='w-14 h-14 rounded-md' />
        </button>
      ...
      <div className='flex flex-[3] items-center justify-center gap-4'>
        {playlist[currentTrackIndex].favorite ? (
